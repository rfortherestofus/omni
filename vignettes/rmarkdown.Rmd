...
When you type `new_omni_report()` you'll get a pop-up like this. Just hit save and then find the report.Rmd (or whatever location you chose) and start working.
