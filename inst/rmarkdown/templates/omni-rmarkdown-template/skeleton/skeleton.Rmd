...
output:
  pagedown::html_paged:
    ...
    css: ["style/omni-style.css", "style/omni-page.css", "style/omni-default.css"]
    include: 
      in_header: "style/meta_lof_js.html"
...
<aside class = "info_call">

<p class="info_call_title"> Information call out</p>

Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus faucibus ornare suspendisse sed nisi lacus sed viverra tellus.
