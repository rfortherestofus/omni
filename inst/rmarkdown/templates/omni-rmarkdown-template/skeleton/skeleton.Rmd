...
customjs: "`r system.file('assets/omni_rmd_template/js/lof.js', package = 'omni')`"
...
abstract: >-
  ```{r, child = system.file('assets/omni_rmd_template/rmd/abstract.Rmd', package = 'omni')}
  ```
---
...
knitr::include_graphics(system.file("assets/omni_rmd_template/images/example_figure.png", package = "omni"))
```
