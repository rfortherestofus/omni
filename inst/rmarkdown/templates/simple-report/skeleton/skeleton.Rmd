...
```{r ggplot, fig.height=3, fig.cap = "Title", out.extra='data-prefix="Chart"'}
iris %>%
  group_by(Species) %>%
...
```{r img, fig.cap = "Title", out.width="200px", fig.align='center', out.extra='data-prefix="Figure"'}
knitr::include_graphics(system.file("assets/omni_simple_report/images/example_figure.png", package = "omni"))
```
...
```{r table, fig.cap="Title", out.extra='data-prefix="Table"'}
mtcars %>%
  slice(1:5) %>%
