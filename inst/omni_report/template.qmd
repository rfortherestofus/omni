...
format:
    omni_report-html:
      logo-ref: logo.png # logo-csi.png | Some other file
      logo-height: default # or <xx>px
      organization-name: Omni Institute # or: Center for Social Investment
