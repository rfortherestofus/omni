  ...
  <br>
  <br>
  OMNI Institute `r rmarkdown::metadata$report_year`. `r rmarkdown::metadata$title`. Submitted to `r rmarkdown::metadata$client_organization`, `r rmarkdown::metadata$client_city`, `r rmarkdown::metadata$client_state`.
