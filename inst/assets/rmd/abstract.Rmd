 <img class = "omni_logo_abstract" src = "`r system.file('assets/omni_rmd_template/images/omni-logo-horizontal.svg', package = 'omni')`">
  <img class = "orange_rect_abstract" src = "`r system.file('assets/omni_rmd_template/images/orange-rectangle.svg', package = 'omni')`">
  <br>
