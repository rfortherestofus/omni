  ...
  <span class="acknowledgement">
    ...
    <p>Omni Institute wants to thank `r rmarkdown::metadata$acknowledgements` for their contributions to the creation of this report.</p>
  </span>
  <p class="suggested-citation">Suggested Citation:</p>
  <p>Omni Institute `r rmarkdown::metadata$report_year`. `r gsub("<br\\s*/?>", " ", rmarkdown::metadata$title)`. Submitted to `r rmarkdown::metadata$client_name`, `r rmarkdown::metadata$client_state`.</p>
  </div>
